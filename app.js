...
const app = express();
mongoose.connect('mongodb+srv://root:root@cluster0.ojfze.mongodb.net/journalDB?retryWrites=true&w=majority');
...
app.get("/", function(req, res){
  ...
  res.render("home",{startingContent: homeStartingContent,entry: foundItems});
  });
});
